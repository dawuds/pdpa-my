...
3. [Scope of Processing and Permitted Processing Activities](#3-scope-of-processing-and-permitted-processing-activities)
4. [Processor's Obligation to Process Only on Written Instructions](#4-processors-obligation-to-process-only-on-written-instructions)
5. [Confidentiality Obligations of Processor Personnel](#5-confidentiality-obligations-of-processor-personnel)
6. [Security Measures and Minimum Security Standards](#6-security-measures-and-minimum-security-standards)
7. [Sub-Processor Authorization and Notification Requirements](#7-sub-processor-authorization-and-notification-requirements)
8. [Data Subject Rights Assistance Obligations](#8-data-subject-rights-assistance-obligations)
9. [Breach Notification Requirements](#9-breach-notification-requirements)
10. [Audit and Inspection Rights](#10-audit-and-inspection-rights)
11. [Data Return, Deletion, and Destruction upon Termination](#11-data-return-deletion-and-destruction-upon-termination)
12. [Cross-Border Transfer Restrictions and Safeguards](#12-cross-border-transfer-restrictions-and-safeguards)
13. [Term and Termination](#13-term-and-termination)
14. [Liability and Indemnification](#14-liability-and-indemnification)
15. [Governing Law and Dispute Resolution](#15-governing-law-and-dispute-resolution)
...
*This section should define the boundaries of the agreement — what personal data is covered, which processing activities are governed, and which organizational units or systems are in scope.*
...
In the event of any conflict between this Agreement and the Principal Agreement with respect to the processing of personal data, the terms of this Agreement shall prevail.

---

## 2. Definitions

*Define all key terms used throughout the agreement to ensure clarity and consistent interpretation. Terms should align with PDPA 2010 definitions where applicable.*
...
| **Applicable Law** | Any law, statute, regulation, order, directive, or code of practice applicable to the processing of personal data, including the PDPA and any guidelines issued by the Commissioner. |

---

## 3. Scope of Processing and Permitted Processing Activities

*This section must precisely describe what personal data is being processed, for what purpose, and by what means. Specificity here is critical for audit defensibility and PDPA compliance.*

### 3.1 Description of Processing

The Data Processor shall process personal data only to the extent necessary to provide the services under the Principal Agreement. The details of processing are set out in **Appendix A** and summarized below:

| Parameter | Details |
|---|---|
| **Subject Matter of Processing** | [Brief description, e.g., "Customer identity verification and transaction processing"] |
| **Duration of Processing** | [Duration aligned with Principal Agreement, e.g., "For the term of the Principal Agreement and [X] months thereafter for deletion/return"] |
...
The Data Processor acknowledges that it shall have no authority to make independent determinations regarding the purposes or means of processing personal data beyond what is expressly authorized under this Agreement.

---

## 5. Confidentiality Obligations of Processor Personnel

*This section ensures that individuals who access personal data on behalf of the processor are bound by enforceable confidentiality obligations, consistent with PDPA data protection principles.*

### 5.1 Personnel Access Controls

The Data Processor shall ensure that access to personal data is restricted to:

- Personnel who have a strict need-to-know for the performance of their duties under this Agreement;
- Personnel who have been individually authorized in writing by the Data Processor; and
- Personnel who are subject to appropriate and enforceable confidentiality obligations.

### 5.2 Confidentiality Undertakings

The Data Processor shall ensure that all personnel engaged in the processing of personal data:

- Are bound by written confidentiality obligations (whether by employment contract, contractor agreement, or standalone confidentiality undertaking) that survive termination of their engagement;
- Are informed of the confidential nature of the personal data and the relevant processing restrictions;
- Have received adequate training on data protection requirements, including PDPA obligations, prior to accessing personal data; and
- Are subject to disciplinary procedures in the event of unauthorized disclosure.

### 5.3 Personnel Screening

The Data Processor represents and warrants that it conducts appropriate background checks on personnel who will have access to personal data, consistent with Applicable Law and industry best practice.

### 5.4 Post-Termination Obligations

Confidentiality obligations under this Section shall survive termination or expiry of this Agreement and shall continue for a period of **[X] years** after the termination of an individual's access to personal data, or indefinitely in respect of trade secrets.
...
## 6. Security Measures and Minimum Security Standards

*Specify the technical and organizational security controls the processor must implement, consistent with PDPA's security principle and applicable BNM/NACSA guidelines. This section should be as specific as possible.*

### 6.1 General Security Obligation

The Data Processor shall implement and maintain appropriate technical and organizational measures to protect personal data against:

- Accidental or unlawful destruction, loss, or alteration;
- Unauthorized or unlawful disclosure or access; and
- Any other form of unlawful processing.

Such measures shall be proportionate to the risks presented by the processing, taking into account the state of the art, costs of implementation, the nature, scope, context, and purposes of processing.

### 6.2 Minimum Security Standards

The Data Processor shall implement, at a minimum, the following security controls:

| Control Domain | Minimum Requirement |
|---|---|
| **Access Control** | Role-based access control (RBAC); multi-factor authentication (MFA) for all privileged access; principle of least privilege enforced |
| **Encryption** | Encryption at rest (AES-256 or equivalent); encryption in transit (TLS 1.2 or higher) |
| **Network Security** | Firewalls, intrusion detection/prevention systems (IDS/IPS); network segmentation for systems processing personal data |
| **Vulnerability Management** | Regular vulnerability scanning; patching within [X] days for critical vulnerabilities; annual penetration testing |
| **Logging and Monitoring** | Audit logging of all access to personal data; log retention for minimum [X] months; 24/7 security monitoring |
| **Physical Security** | Physical access controls to data centers and server rooms; CCTV monitoring; visitor management |
| **Backup and Recovery** | Regular encrypted backups; tested recovery procedures; recovery time objective (RTO) of [X] hours |
| **Endpoint Security** | Anti-malware; device encryption; mobile device management (MDM) for devices accessing personal data |
| **Secure Development** | SDLC security practices; code review; security testing before deployment (where applicable) |
| **Incident Response** | Documented and tested incident response plan; designated security contact |
...
The Data Processor shall maintain and make available upon request:

- Information security policies and procedures relevant to personal data processing;
- Records of security training completed by personnel;
- Results of penetration tests and vulnerability assessments (with executive summaries at minimum); and
- Current certifications, if any (e.g., ISO/IEC 27001, SOC 2 Type II).
...
- Simultaneously via email and telephone (or as otherwise agreed in writing).

### 9.2 Content of Initial Notification

The initial breach notification shall, to the extent information is available, include:
...
- [ ] The name and contact details of the Data Processor's designated data protection contact or security officer; and
- [ ] The date and time the breach was discovered and by whom.

Where complete information is not available within 24 hours, the Data Processor shall provide a preliminary notification with available information and supplement it with further information as it becomes available, without undue further delay.
...
- Interview relevant personnel of the Data Processor regarding data protection practices; and
- Commission third-party auditors or assessors, subject to reasonable confidentiality obligations.

### 10.2 Frequency of Audits

- **Standard audits:** No more than **[once per calendar year]**, unless a Personal Data Breach or material non-compliance has occurred;
- **For-cause audits:** At any time following a Personal Data Breach, a material non-compliance, or a direction from a regulatory authority, with **[X] days' notice** (or shorter notice in urgent circumstances).
...
## 11. Data Return, Deletion, and Destruction upon Termination

*Specify exactly what happens to personal data at the end of the processing relationship — a critical PDPA compliance requirement and essential for data lifecycle management.*
...
|---|---|---|
| **Return** | Data Processor returns all personal data in a structured, commonly used, machine-readable format (e.g., CSV, JSON, SQL dump) | Within [X] days of election notice |
| **Deletion** | Data Processor permanently deletes all personal data using a recognized secure deletion standard (e.g., NIST SP 800-88) | Within [X] days of election notice |
| **Destruction** | Physical destruction of storage media containing personal data, with certificate of destruction provided | Within [X] days of election notice |

Where no election is made within the specified period, the Data Processor shall default to **secure deletion**.

### 11.3 Retention for Legal Purposes
...
- The method of deletion or destruction used; and
- Confirmation that all Sub-Processors have similarly deleted or destroyed the personal data.

---

## 12. Cross-Border Transfer Restrictions and Safeguards

*Address the PDPA's restrictions on transferring personal data outside Malaysia. This section is critical for organizations engaging international processors or using cloud services with servers outside Malaysia.*
...
- An exemption applies under Section 12.3.

### 12.2 Adequate Safeguards

Where a transfer to a country not providing adequate protection is authorized, the Data Processor shall ensure that adequate safeguards are implemented, which may include:

| Safeguard Type | Description |
|---|---|
| **Contractual Clauses** | Binding contractual obligations on the overseas recipient equivalent to those under the PDPA |
| **Binding Corporate Rules** | Approved intra-group data transfer policies for multinational processor groups |
| **Certification/Adequacy** | Transfer to a jurisdiction recognized as adequate by the Commissioner or under a mutual recognition framework |
| **Data Localization** | Storing and processing personal data only on servers physically located in Malaysia |
...
|---|---|---|
| [Country/Territory 1] | [e.g., Contractual clauses / Adequacy] | [Reference] |
| [Country/Territory 2] | [e.g., Data localization / BCRs] | [Reference] |

*Add rows as required. Leave blank if no cross-border transfers are authorized.*
...
This Agreement shall commence on the **Effective Date** and shall continue for the duration of the Principal Agreement, unless terminated earlier in accordance with this Section.

### 13.2 Termination for Cause

Either Party may terminate this Agreement with immediate effect by written notice if the other Party:

- Commits a material breach of this Agreement and fails to remedy such breach within **[X] days** of written notice requiring it to do so;
- Becomes insolvent, enters administration, or is subject to winding-up proceedings; or
- Is found by a regulatory authority to have committed a material violation of the PDPA or Applicable Law in connection with the processing of personal data under this Agreement.
...
Termination or expiry of this Agreement shall not affect any accrued rights or liabilities of either Party. Sections 5 (Confidentiality), 9 (Breach Notification, for breaches discovered post-termination), 11 (Data Return and Deletion), 14 (Liability), and 15 (Governing Law) shall survive termination or expiry.
...
*Insert any agreed limitation of liability provisions consistent with the Principal Agreement and negotiated terms.*
...
1. Escalated first to senior representatives of each Party for good faith negotiation for a period of **[X] days**;
2. If unresolved, referred to mediation administered by the **Asian International Arbitration Centre (AIAC)** in accordance with its Mediation Rules; and
3. If mediation fails, submitted to the exclusive jurisdiction of the **courts of Malaysia**.
...
| Return or delete data upon termination | A | C | R | R | R |
| Maintain DPA documentation | A/R | I | R | I | — |
| Review and update this Agreement | A/R | C | R | I | — |
| Monitor sub-processor compliance | C | I | A/R | R | — |
| Conduct cross-border transfer assessments | A/R | C | C | I | — |
...
- Upon initial engagement and at the renewal of the Principal Agreement;
...
| [1.1] | [Date] | [Author Name / Role] | [Description of change] |
| [2.0] | [Date] | [Author Name / Role] | [Description of major revision] |

### 17.3 Approval Sign-Off

*This Agreement must be reviewed and approved by the following stakeholders prior to execution. Signatures below confirm review, approval, and commitment to the obligations herein.*
...
The following legislation, guidelines, and standards are referenced in or inform the requirements of this Agreement:
...
| **Personal Data Protection (Amendment) Act 2024** | Amendments to PDPA including breach notification obligations | Informs breach notification timelines and obligations in Section 9 of this Agreement |
| **BNM Risk Management in Technology (RMiT) Policy** | Bank Negara Malaysia — Technology Risk Management | Information security requirements for financial institutions; informs Section 6 minimum security standards |
| **ISO/IEC 27001:2022** | Information Security Management Systems | International standard informing security control requirements in Section 6 |
| **NIST SP 800-88** | Guidelines for Media Sanitization | Standard for secure deletion referenced in Section 11 |
| **NACSA Cybersecurity Framework** | National Cyber Security Agency — Cybersecurity Framework | Informs security baseline requirements for critical national information infrastructure |
...
*Complete this appendix with the specific details of processing activities. This is a legally operative document and must be accurate and comprehensive.*

| Field | Details |
|---|---|
| **Subject Matter** | [Detailed description of the processing subject matter] |
| **Duration** | [Processing duration, including retention periods] |
| **Nature of Processing** | [Specific operations performed, e.g., storage, analysis, transmission] |
| **Purpose** | [Specific, explicit, and legitimate purposes] |
| **Categories of Personal Data** | [List all categories, including sensitive personal data if applicable] |
| **Categories of Data Subjects** | [e.g., Customers, employees, third-party contacts] |
| **Technical Environment** | [Brief description of systems, platforms, and infrastructure used] |
| **Data Flow Diagram Reference** | [Reference to attached data flow diagram, if applicable] |

---

### Appendix B — Authorized Sub-Processors

*List all Sub-Processors authorized at the time of signing. This list must be kept current. The Data Processor must follow the notification process in Section 7 for any additions or changes.*

| Sub-Processor Name | Registered Country | Processing Activities | Personal Data Categories | Date Authorized |
|---|---|---|---|---|
| [Sub-Processor 1 Name] | [Country] | [Description of activities] | [Data categories] | [Date] |
| [Sub-Processor 2 Name] | [Country] | [Description of activities] | [Data categories] | [Date] |
| *[Add rows as required]* | | | | |

---

### Appendix C — Key Contacts and Escalation
...
|---|---|---|---|---|
| Data Protection Officer | [Name] | [Email] | [Tel] | Primary |
| Legal Counsel | [Name] | [Email] | [Tel] | Secondary |
| CISO / IT Security | [Name] | [Email] | [Tel] | Secondary |
| Executive Escalation | [Name] | [Email] | [Tel] | Escalation |

**Data Processor Contacts:**

| Role | Name | Email | Telephone | Escalation Level |
|---|---|---|---|---|
| Data Protection Contact | [Name] | [Email] | [Tel] | Primary |
| Security Incident Manager | [Name] | [Email] | [Tel] | Primary (Breach) |
| Account Manager | [Name] | [Email] | [Tel] | Secondary |
| Executive Escalation | [Name] | [Email] | [Tel] | Escalation |

---

### Appendix D — Security Standards and Certifications

*List the Data Processor's current certifications, assessments, and compliance attestations relevant to information security and data protection.*

| Certification / Standard | Issuing Body | Certification Scope | Valid From | Valid To | Certificate Reference |
|---|---|---|---|---|---|
| [e.g., ISO/IEC 27001:2022] | [e.g., BSI / SIRIM] | [Scope of certification] | [Date] | [Date] | [Ref No.] |
| [e.g., SOC 2 Type II] | [e.g., Licensed CPA Firm] | [Scope] | [Date] | [Date] | [Ref No.] |
| [e.g., PCI DSS Level 1] | [Qualified Assessor] | [Scope] | [Date] | [Date] | [Ref No.] |

---

### Appendix E — Cross-Border Transfer Safeguards

*Document the specific safeguards in place for each authorized cross-border transfer. This appendix should be updated whenever transfer arrangements change.*

| Transfer Route | Origin | Destination | Personal Data Categories | Safeguard Mechanism | Supporting Documentation | Review Date |
|---|---|---|---|---|---|---|
| [Transfer 1] | Malaysia | [Country] | [Categories] | [Contractual clauses / BCRs / Adequacy] | [Doc reference] | [Date] |
| [Transfer 2] | Malaysia | [Country] | [Categories] | [Safeguard mechanism] | [Doc reference] | [Date] |
...
> **Document Control Notice:** This template is classified **Confidential**. Distribution is restricted to authorized personnel on a need-to-know basis. Unauthorized disclosure, reproduction, or transmission of this document is prohibited. Printed copies are uncontrolled — refer to the document management system for the current version.